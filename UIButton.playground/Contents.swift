...
class ViewController: UIViewController {
    override func viewDidLoad() {
        ...
        let button1 = UIButton(frame:CGRectMake(10, 150, 100, 30))
        ...
        // 8，按钮触摸点击事件响应
        // 
        button.addTarget(self, action: #selector(tapped), forControlEvents: .TouchUpOutside)
